...
import { IAiAgentService, RiskAssessmentResult } from '../ai-agent';
...
import { createMockNext, createMockRequest, createMockResponse } from '../../../tests/helpers/mockExpress';
...
function buildMockAgent(): jest.Mocked<IAiAgentService> {
...
describe('RiskAssessmentController', () => {
  ...
  let agent: jest.Mocked<IAiAgentService>;
